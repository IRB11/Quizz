...
namespace Quizz.Domain.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240620124148_Add Salt and confirm password to user")]
    partial class AddSaltandconfirmpasswordtouser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Quizz.Domain.Infrastructure.Data.Entities.EFQuiz", b =>
                {
                    ...
                    b.HasOne("Quizz.Domain.Infrastructure.Data.Entities.EFLevel", null)
                        .WithMany("Quizzes")
                        .HasForeignKey("EFLevelId");
