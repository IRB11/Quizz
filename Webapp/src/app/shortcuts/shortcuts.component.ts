...
export class ShortcutsComponent {
  shortcuts: Shortcut[] = [
    { name: 'Gestion Agents', link: '/Agent', iconUrl: '../../assets/img/iconagentmanager.png', description: 'Gérer les agents'},
    { name: 'Gestion Candidats', link: '/Candidats', iconUrl: '../../assets/img/iconcandidats.png', description: 'Gérer les candidats'},
    { name: 'Quizz Bank', link: '/quizz', iconUrl: '../../assets/img/iconquizzbank.png', description: 'Gérer question/réponses' },
    { name: 'Gestion Quizz', link: '/quizz', iconUrl: '../../assets/img/icongenererquizz.png', description: 'Gérer quizz' },
